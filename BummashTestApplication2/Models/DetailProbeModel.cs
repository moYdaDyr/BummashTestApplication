...
{
    public class DetailProbeModel : IDetailModel
    {
        ...
        public void CalculateModel(IInitialDetailModel initDetail)
        {
            ...
            HeightBlank = initDetail.Height * initDetail.NumberOfDetails + initDetail.CutLength * (initDetail.NumberOfDetails - 1) + initDetail.ThermoOverlap + initDetail.ProbingOverlap;
